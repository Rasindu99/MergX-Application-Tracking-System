...
export default function PostTag(props) {
  ...
  return (
    <div>
      <div className='accLabel flex flex-row  bg-[#2b2b2b] sm:pl-[5px]  items-center justify-start rounded-[30px]  sm:gap-[4px] esm:w-[110px] esm:h-[25px] 450px:w-[140px] 450px:h-[35px]   sm:w-[150px] sm:h-[45px]  lg:rounded-[25px]  lg:gap-[8px] lg:w-[200px] lg:h-[60px] sm:gap-[6px] sm:w-[180px] sm:h-[50px] sm:rounded-[30px] esm:w-[fit-content]'>
