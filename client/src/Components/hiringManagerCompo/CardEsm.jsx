...
export default function CardEsm(props) {
  ...
  return (
    <div>
      <div className={`card_s p-[5px] w-[150px] h-[150px] bg-[linear-gradient(180deg,_rgba(234,_113,_34,_0.2)_0%,_rgba(43,_43,_43,_0)_100%)] 320px:rounded-[5px] 500px:rounded-[15px] sm:rounded-[30px] flex justify-center items-center`}>
