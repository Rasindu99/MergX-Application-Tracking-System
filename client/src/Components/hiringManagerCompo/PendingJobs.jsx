    ...
    <div>
      <div className="bg-[linear-gradient(180deg,_rgba(98,_92,_88,_0.136)_0%,_rgba(48,_48,_48,_0.2)_100%)] p-[10px] rounded-[25px] mb-[10px] 320px:text-[0.5rem]  450px:text-[0.8rem] sm:text-[0.9rem]   900px:text-[1.1rem]  1010px:text-[1.2rem] ">
        <div className="JobPostCover flex flex-row items-center justify-evenly mx-[25px] my-0 px-[25px] py-0">
          {/* <div className="jobPost flex flex-row items-center esm:gap-0.1 500px:gap-0.5 sm:gap-0.8 md:gap-0 w-full justify-evenly"> */}
        ...
        <div>
          <div className="popup p-[30px] bg-[rgba(43,43,43)] border-[1px] border-[solid] border-[#EA7122] w-[800px] rounded-[30px] mt-[20px] mb-[20px] z-50 fixed top-1/2 left-2/4 -translate-x-1/2 -translate-y-1/2">
                ...
                <tr className="border-spacing-[0_10px]">
                  ...
                  <td className="text-[rgba(255,255,255,0.75)]">
                    {props.requiredSkills.map((item) => (
                      <p key={item} className="inline-block mr-1 ">
                        {item} /
                      </p>
                    ))}
            ...
            <p className="text-[rgba(255,255,255)] text-center">
              ...
              maintains software applications, systems, and programs. They
              possess expertise in programming languages, algorithms, and
              problem-solving techniques to create efficient and functional
              software solutions. Software engineers collaborate with
              cross-functional teams, including designers and product managers,
              to understand requirements and deliver high-quality software
              products. They are adept at debugging and troubleshooting issues,
              ensuring the smooth functioning of the software throughout its
              lifecycle. Continuous learning and staying updated with emerging
              technologies are integral aspects of a software engineer's role to
              adapt to the dynamic and evolving landscape of the tech industry. */}
              {props.description}
            </p>
