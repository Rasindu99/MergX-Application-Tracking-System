    ...
    <div className='flex flex-col justify-center items-center p-5 overflow-auto w-full z-10 my-comp'>
      ...
      <div id="preview-sc" class="print_area w-[794px] h-[1110px]" ref={divRef}>
        <div class="w-full h-full">
          <div class="preview-cnt h-full">
            <div class="preview-cnt-l bg-green-jimi text-white">
              <div class="preview-blk">
                ...
                <div class="preview-item">
                  <span class="preview-item-val text-uppercase-jimi fw-6 ls-1" id="designation_dsp">{formData.designation}</span>
                </div>
              </div>
